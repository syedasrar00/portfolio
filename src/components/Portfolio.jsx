...
export default function Portfolio() {
  return (
    <div className='py-20' id='portfolio'>
        ...
        <div className="grid grid-cols-1 mx-auto max-w-[1400px] xl:grid-cols-3 md:grid-cols-2 gap-10 justify-center xl:flex xl:justify-center">
            {variable.portfolio.map(obj => {
                return <div key={obj.title} className='mx-auto p-8 rounded-xl bg-[rgb(100,116,139,25%)]'>
                    ...
                    <a href={obj.githubLink} className='border text-gray-200 border-blue-500 px-3 py-1.5 rounded-md hover:bg-cyan-500 hover:text-gray-700'>Github Link</a>
                </div>
            })}
        </div>
    </div>
