    ...
    <div className='my-8 py-20' id='about'>
        ...
        <div className="my-5 justify-center contents gap-x-10 lg:flex">
            ...
            <div className="container mx-auto max-w-[285px] md:max-w-[413px] lg:mx-0">
                ...
                <p className='my-5'>Tech-savvy Full Stack Web Developer advanced knowledge of back-end 
                languages and tools like java, Spring Boot, MySQL and MongoDB, and . Intermediate knowledge of 
                React and other front-end languages. Skillful creating servers and databases for functionality and 
                designing and developing APIs. Hardworking collaborator on every project I work on.</p>
